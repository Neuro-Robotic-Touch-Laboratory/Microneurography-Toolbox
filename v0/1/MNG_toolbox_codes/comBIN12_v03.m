function [spikeMatrix, peak_idxs, peakTimes_ms, classes, peak_vals,  dip1, dip2 ]=comBIN12_v01(aaa,filename,NBINS_peak,NBINS_dip,NBINS_dip2,npointsbeforepeak,npointsafterpeak)
