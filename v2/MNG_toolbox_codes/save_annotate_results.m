...
for i = 1:length(int_idxs)
    ...
    if ~isnan(app.settings.channel_idx.msna)
        ...
        if ~isnan(borders(int_idxs(i),1))
            tmp_borders = [ceil(borders(int_idxs(i),1)/ts_msna(1)) , floor(borders(int_idxs(i),2)/ts_msna(1))];
    ...
    if ~isnan(app.settings.channel_idx.bldp)
        ...
        if ~isnan(borders(int_idxs(i),1))
            tmp_borders = [ceil(borders(int_idxs(i),1)/ts_bp(1)), floor(borders(int_idxs(i),2)/ts_bp(1))];
    ...
    if ~isnan(app.settings.channel_idx.ecg)
        ...
        if ~isnan(borders(int_idxs(i),1))
            tmp_borders = [ceil(borders(int_idxs(i),1)/ts_ecg(1)), floor(borders(int_idxs(i),2)/ts_ecg(1))];
    ...
    if ~isnan(app.settings.channel_idx.resp)
        ...
        if ~isnan(borders(int_idxs(i),1))
            tmp_borders = [ceil(borders(int_idxs(i),1)/ts_resp(1)), floor(borders(int_idxs(i),2)/ts_resp(1))];
