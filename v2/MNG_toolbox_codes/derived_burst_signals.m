...
use_idx = find(app.burst_res.use_burst(:,1));
...
app.data(idx).data = interp1(app.burst_res.t_burst(use_idx),app.burst_res.burst_int(use_idx),tmp)';
...
app.data(idx).unit = 's';
app.data(idx).tic_multipl = 0.01/min_ts;
app.data(idx).data = interp1(app.burst_res.t_burst(use_idx),app.burst_res.burst_dur(use_idx),tmp)';
tmp_idx = [find(~isnan(app.data(idx).data),1) ,  find(~isnan(app.data(idx).data),1,'last')];
app.data(idx).data(1:tmp_idx(1)-1) = app.data(idx).data(tmp_idx(1));
app.data(idx).data(tmp_idx(2)+1:end) = app.data(idx).data(tmp_idx(2));
app.data(idx).ts = [tmp(1),tmp(end)];
...
app.data(idx).unit = 's';
app.data(idx).tic_multipl = 0.01/min_ts;
app.data(idx).data = interp1(app.burst_res.t_burst(use_idx),app.burst_res.burst_amp(use_idx),tmp)';
tmp_idx = [find(~isnan(app.data(idx).data),1) ,  find(~isnan(app.data(idx).data),1,'last')];
app.data(idx).data(1:tmp_idx(1)-1) = app.data(idx).data(tmp_idx(1));
app.data(idx).data(tmp_idx(2)+1:end) = app.data(idx).data(tmp_idx(2));
app.data(idx).ts = [tmp(1),tmp(end)];
...
app.data(idx).unit = 's';
app.data(idx).tic_multipl = 0.01/min_ts;
app.data(idx).data = interp1(app.burst_res.t_burst(use_idx(1:end-1)),diff(app.burst_res.t_burst(use_idx)),tmp)';
tmp_idx = [find(~isnan(app.data(idx).data),1) ,  find(~isnan(app.data(idx).data),1,'last')];
app.data(idx).data(1:tmp_idx(1)-1) = app.data(idx).data(tmp_idx(1));
app.data(idx).data(tmp_idx(2)+1:end) = app.data(idx).data(tmp_idx(2));
app.data(idx).ts = [tmp(1),tmp(end)];
