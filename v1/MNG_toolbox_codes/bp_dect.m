function [ footIndex, systolicIndex, notchIndex, dicroticIndex, time, bpwaveform ] = bp_dect( inWaveform, inFs, verbose, varargin )
...
%             subThreshold = winmean(subThresholdWindow, 1.5);
            subThreshold = winmean(subThresholdWindow, 1);
